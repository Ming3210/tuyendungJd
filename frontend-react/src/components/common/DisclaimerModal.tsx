    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-lg max-w-lg w-full mx-4 p-6 z-10">
        ...
        <p className="mb-4">
          ...
          cảm! Cảm ơn bạn đã ghé thăm và trải nghiệm sản phẩm của chúng tôi. Nếu bạn gặp bất kỳ vấn đề, vui lòng liên hệ với chúng tôi để được hỗ trợ. Chúng tôi rất mong nhận được phản hồi từ bạn để cải thiện dịch vụ. Chúc bạn có trải nghiệm tốt trên trang web của chúng tôi!
        </p>
