-- =============================================
-- SEED DATA 99.9% REALISTIC FOR nhom5_db
-- =============================================

-- 1. USERS (Restored to original 15)
...
DELETE FROM jobs;
INSERT INTO jobs (id, title, quantity, gender, skills, salary_current, salary, province, district, image, address, working_time, deadline, industry, enterprise_id, flight, update_date, description, `rank`, benefits_description, required) VALUES
-- EMIR Group
(1, 'Trưởng Phòng Công Nghệ Thông Tin (TECH LEAD) - Lương UPTO 50M', 1, 'Bất kỳ', 'Expert', 'VND', '35 - 50 Triệu', 'Thành phố Hà Nội', 'Cầu Giấy', 'https://res.cloudinary.com/djppquc7s/image/upload/v1712739000/job_techlead.jpg', 'Tòa nhà EMIR Tower', 'Full-time', '31/12/2025', 'IT', 1, 'verified', '2024-04-10', 
'["Quản lý đội ngũ phát triển 10 người","Xây dựng kiến trúc hệ thống Microservices","Review code và mentor thành viên"]', '["Manager","Lead"]', '["Lương tháng 13 + Thưởng hiệu quả lên tới 3 tháng lương","Bảo hiểm sức khỏe cao cấp EMIR Care","Cơ hội sở hữu cổ phần ưu đãi (ESOP)"]', 
'["Tốt nghiệp ĐH chuyên ngành CNTT","Tối thiểu 3 năm kinh nghiệm Lead","Thành thạo Java/Go và kiến thức về AWS"]'),

(2, 'Chuyên Viên Phân Tích Tài Chính Cao Cấp (Senior Financial Analyst)', 2, 'Bất kỳ', 'Advanced', 'VND', '25 - 40 Triệu', 'Thành phố Hà Nội', 'Cầu Giấy', 'https://res.cloudinary.com/djppquc7s/image/upload/v1712739000/job_finance.jpg', 'Tòa nhà EMIR Tower', 'Full-time', '31/12/2025', 'IT', 1, 'verified', '2024-04-10', 
'["Thực hiện báo cáo tài chính định kỳ","Phân tích rủi ro danh mục đầu tư","Thẩm định các dự án M&A"]', '["Senior"]', '["Môi trường làm việc chuyên nghiệp, chuẩn quốc tế","Hỗ trợ cơm trưa và phí gửi xe"]', 
'["Có chứng chỉ CFA là lợi thế","Kỹ năng Excel và SQL tốt","Tiếng Anh thương mại thành thạo"]'),

-- PowerGate
(3, 'Kỹ Sư Phát Triển Phần Mềm (C/C++/Java/Golang/Python) - Gross $2500', 5, 'Bất kỳ', 'Advanced', 'USD', '1500 - 2500', 'Thành phố Hà Nội', 'Thanh Xuân', 'https://res.cloudinary.com/djppquc7s/image/upload/v1766996331/Job02_weqmfy.png', 'Tòa nhà Toyota Thanh Xuân', 'Full-time', '31/12/2025', 'IT', 2, 'verified', '2024-04-10', 
'["Phát triển Core Back-end cho hệ thống ERP quốc tế","Tối ưu hóa performance database Oracle","Thiết kế API chuẩn RESTful"]', '["Senior"]', '["Làm việc tại văn phòng hạng A","Nghỉ Thứ 7, Chủ Nhật","Khám sức khỏe tại Vinmec"]', 
'["Thống thạo 1 trong các ngôn ngữ: C++, Java, Golang, Python","Tư duy thuật toán tốt","Tiếng Anh tốt"]'),

(4, 'Frontend Developer (NodeJS + ReactJS) - Middle Level', 3, 'Bất kỳ', 'Advanced', 'VND', '20 - 35 Triệu', 'Thành phố Hà Nội', 'Thanh Xuân', 'https://res.cloudinary.com/djppquc7s/image/upload/v1712739000/job_frontend.jpg', 'Tòa nhà Toyota Thanh Xuân', 'Full-time', '31/12/2025', 'IT', 2, 'verified', '2024-04-10', 
'["Phát triển giao diện ứng dụng web hiện đại","Tích hợp logic backend qua Redux","Đảm bảo tính tương thích trình duyệt"]', '["Middle"]', '["Review lương 2 lần/năm","Du lịch hè nước ngoài","Laptop Macbook Pro"]', 
'["Kinh nghiệm 2-3 năm ReactJS","Biết về TailWindCSS là lợi thế"]'),

-- CMC
(5, 'Fullstack Developer (NodeJS + ReactJS) - Good At English, At least 5 Yrs Exp', 4, 'Bất kỳ', 'Expert', 'VND', '30 - 45 Triệu', 'Thành phố Hà Nội', 'Cầu Giấy', 'https://res.cloudinary.com/djppquc7s/image/upload/v1766996331/Job03_cmc.png', 'CMC Tower', 'Full-time', '31/12/2025', 'IT', 3, 'verified', '2024-04-10', 
'["Tham gia các dự án Cloud của tập đoàn","Thiết kế kiến trúc Cloud-Native","Optimize server performance"]', '["Senior"]', '["Phúc lợi từ tập đoàn công nghệ hàng đầu","Môi trường trẻ trung, năng động"]', 
...
SELECT 
    ...
    (n % 10 + 1),
    'Bất kỳ',
    CASE WHEN n % 4 = 1 THEN 'Senior' WHEN n % 4 = 2 THEN 'Middle' ELSE 'Junior' END,
    CASE WHEN n % 2 = 1 THEN 'VND' ELSE 'USD' END,
    CASE WHEN n % 2 = 1 THEN CONCAT(18+(n%7), '-', 30+(n%7), ' Triệu') ELSE CONCAT('1', (n%5)+2, '00 - 2', (n%5)+4, '00') END,
    CASE WHEN n % 3 = 1 THEN 'Thành phố Hà Nội' WHEN n % 3 = 2 THEN 'Thành phố Hồ Chí Minh' ELSE 'Thành phố Đà Nẵng' END,
    'Quận trung tâm',
    'https://res.cloudinary.com/djppquc7s/image/upload/v1766996331/Job02_weqmfy.png',
    'Văn phòng công ty',
    'Full-time',
    '31/12/2025',
    'IT',
    ...
    'verified',
    '2024-04-10',
    '["Thực hiện phân tích và phát triển tính năng mới","Hỗ trợ các thành viên khác trong team","Gửi báo cáo công việc hàng tuần"]',
    CASE WHEN n % 3 = 1 THEN '["Senior"]' WHEN n % 3 = 2 THEN '["Junior"]' ELSE '["Middle"]' END,
    '["Thưởng định kỳ","Team building quý","Nghỉ lễ tết"]',
    '["Nắm vững kiến thức nền tảng","Có thái độ tốt và cầu tiến"]'
FROM (
